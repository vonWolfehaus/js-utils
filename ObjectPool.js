...
if (typeof exports !== 'undefined') {
	var LinkedList = require('LinkedList'); // automatic commonjs import
}

var ObjectPool = function(classConstructor, instanceSettings, initSize) {
	// public
...
if (typeof exports !== 'undefined') {
	if (typeof module !== 'undefined' && module.exports) {
		exports = module.exports = ObjectPool;
	}
	exports.ObjectPool = ObjectPool;
} else if (typeof define !== 'undefined' && define.amd) {
	define(ObjectPool);
} else {
	root.ObjectPool = ObjectPool;
}
}).call(this);
